...
# Conclusions
Because the p-value is 0.204, I can conclude that living in a border city such as El Paso does not have any statistically significant impact on an individual's view of immigration.  However, in future studies, I would suggest that researchers more carefully investigate the relationship between an invdividual's birth year and their opinions on immigration.  This variable's p-value is <0.001, and thus extremely statistically significant. 
